--------------------------------------------------------------------------------
-- Thr_Firing_Remainder Tests
--------------------------------------------------------------------------------

with AUnit.Reporter.Text;
with AUnit.Run;
with Thr_Firing_Remainder_Tests.Implementation.Suite;
...
procedure Test is
   ...
   procedure Runner is new AUnit.Run.Test_Runner (Thr_Firing_Remainder_Tests.Implementation.Suite.Get);
