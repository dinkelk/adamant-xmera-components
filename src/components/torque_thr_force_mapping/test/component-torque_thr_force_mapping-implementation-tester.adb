--------------------------------------------------------------------------------
-- Torque_Thr_Force_Mapping Component Tester Body
--------------------------------------------------------------------------------

-- Includes:
with Parameter;

package body Component.Torque_Thr_Force_Mapping.Implementation.Tester is
   ...
   begin
      ...
      Self.Thruster_Force_Cmd_History.Init (Depth => 100);
   end Init_Base;
   ...
   begin
      ...
      -- Data product histories:
      Self.Thruster_Force_Cmd_History.Destroy;
   end Final_Base;
   ...
   overriding procedure Thruster_Force_Cmd (Self : in out Instance; Arg : in Thr_Force_Cmd.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Thruster_Force_Cmd_History.Push (Arg);
   end Thruster_Force_Cmd;
