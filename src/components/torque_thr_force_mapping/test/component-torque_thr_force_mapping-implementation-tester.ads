--------------------------------------------------------------------------------
-- Torque_Thr_Force_Mapping Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Torque_Thr_Force_Mapping_Reciprocal;
...
-- shim.
package Component.Torque_Thr_Force_Mapping.Implementation.Tester is

   use Component.Torque_Thr_Force_Mapping_Reciprocal;
   ...
   package Thruster_Force_Cmd_History_Package is new Printable_History (Thr_Force_Cmd.T, Thr_Force_Cmd.Representation.Image);

   -- Component class instance:
   type Instance is new Component.Torque_Thr_Force_Mapping_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Torque_Thr_Force_Mapping.Implementation.Instance;
      -- Connector histories:
      Data_Product_Fetch_T_Service_History : Data_Product_Fetch_T_Service_History_Package.Instance;
      Data_Product_T_Recv_Sync_History : Data_Product_T_Recv_Sync_History_Package.Instance;
      -- Data product histories:
      Thruster_Force_Cmd_History : Thruster_Force_Cmd_History_Package.Instance;
   ...
   -----------------------------------------------
   -- Description:
   --    Data products for the Torque Thr Force Mapping component.
   -- [N] Thruster force command, one entry per thruster slot.
   overriding procedure Thruster_Force_Cmd (Self : in out Instance; Arg : in Thr_Force_Cmd.T);
...
end Component.Torque_Thr_Force_Mapping.Implementation.Tester;
