--------------------------------------------------------------------------------
-- Thr_Firing_Schmitt Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Thr_Firing_Schmitt_Reciprocal;
...
package Component.Thr_Firing_Schmitt.Implementation.Tester is

   use Component.Thr_Firing_Schmitt_Reciprocal;
   ...
   type Instance is new Component.Thr_Firing_Schmitt_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Thr_Firing_Schmitt.Implementation.Instance;
      -- Connector histories:
...
end Component.Thr_Firing_Schmitt.Implementation.Tester;
