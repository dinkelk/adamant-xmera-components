...
package body Component.Css_Weighted_Least_Squares.Implementation is
   ...
   begin
      ...
      -- Call the C algorithm and publish the estimate. Update is qualified because
      -- Parameter_Enums also declares one.
      Self.Data_Product_T_Send (Self.Data_Products.Sun_Heading_Estimate (
         Arg.Time,
         Css_Weighted_Least_Squares_Output.C.Pack (
