--------------------------------------------------------------------------------
-- Css_Weighted_Least_Squares Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Css_Weighted_Least_Squares_Reciprocal;
...
with Data_Product;
with Css_Weighted_Least_Squares_Output.Representation;
...
package Component.Css_Weighted_Least_Squares.Implementation.Tester is

   use Component.Css_Weighted_Least_Squares_Reciprocal;
   ...
   package Sun_Heading_Estimate_History_Package is new Printable_History (Css_Weighted_Least_Squares_Output.T, Css_Weighted_Least_Squares_Output.Representation.Image);

   -- Component class instance:
   type Instance is new Component.Css_Weighted_Least_Squares_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Css_Weighted_Least_Squares.Implementation.Instance;
      -- Connector histories:
      Data_Product_Fetch_T_Service_History : Data_Product_Fetch_T_Service_History_Package.Instance;
      Data_Product_T_Recv_Sync_History : Data_Product_T_Recv_Sync_History_Package.Instance;
      -- Data product histories:
      Sun_Heading_Estimate_History : Sun_Heading_Estimate_History_Package.Instance;
   ...
   -----------------------------------------------
   -- Description:
   --    Data products for the Css Weighted Least Squares component.
   -- [-] The estimated sun heading and body rate, the post-fit residuals, and the
   -- count of sensors that contributed to the fit.
   overriding procedure Sun_Heading_Estimate (Self : in out Instance; Arg : in Css_Weighted_Least_Squares_Output.T);
...
end Component.Css_Weighted_Least_Squares.Implementation.Tester;
