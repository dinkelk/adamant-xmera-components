--------------------------------------------------------------------------------
-- Css_Weighted_Least_Squares Component Tester Body
--------------------------------------------------------------------------------

-- Includes:
with Parameter;

package body Component.Css_Weighted_Least_Squares.Implementation.Tester is
   ...
   begin
      ...
      Self.Sun_Heading_Estimate_History.Init (Depth => 100);
   end Init_Base;
   ...
   begin
      ...
      -- Data product histories:
      Self.Sun_Heading_Estimate_History.Destroy;
   end Final_Base;
   ...
   overriding procedure Sun_Heading_Estimate (Self : in out Instance; Arg : in Css_Weighted_Least_Squares_Output.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Sun_Heading_Estimate_History.Push (Arg);
   end Sun_Heading_Estimate;
