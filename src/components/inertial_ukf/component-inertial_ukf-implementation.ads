--------------------------------------------------------------------------------
-- Inertial_Ukf Component Implementation Spec
--------------------------------------------------------------------------------
...
package Component.Inertial_Ukf.Implementation is

   -- The component class instance record:
   type Instance is new Inertial_Ukf.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   -- No algorithm instance needed -- InertialUKFAlgorithm is purely static.
   type Instance is new Inertial_Ukf.Base_Instance with record
      null;
   end record;
   ...
   overriding function Validate_Parameters (
      ...
      Rw_Array_Config : in Rw_Array_Config_Input.U;
      Vehicle_Config : in Vehicle_Config_Input.U
