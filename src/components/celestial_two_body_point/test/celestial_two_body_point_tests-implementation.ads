--------------------------------------------------------------------------------
-- Celestial_Two_Body_Point Tests Spec
--------------------------------------------------------------------------------

-- This is a unit test suite for the Celestial Two Body Point component
package Celestial_Two_Body_Point_Tests.Implementation is

   -- Test data and state:
   type Instance is new Celestial_Two_Body_Point_Tests.Base_Instance with private;
...
private
   ...
   -- Test data and state:
   type Instance is new Celestial_Two_Body_Point_Tests.Base_Instance with record
      null;
   end record;
