--------------------------------------------------------------------------------
-- Ephem_Nav_Converter Component Tester Body
--------------------------------------------------------------------------------

package body Component.Ephem_Nav_Converter.Implementation.Tester is
   ...
   begin
      ...
      Self.Navigation_Translation_History.Init (Depth => 100);
   end Init_Base;
   ...
   begin
      ...
      -- Data product histories:
      Self.Navigation_Translation_History.Destroy;
   end Final_Base;
         ...
         case Arg.Id is
            ...
            when 0 =>
               Buffer_To_Return (Buffer_To_Return'First .. Buffer_To_Return'First + Ephemeris.Size_In_Bytes - 1) :=
                  Ephemeris.Serialization.To_Byte_Array (Self.Input_Ephemeris);
   ...
   overriding procedure Navigation_Translation (Self : in out Instance; Arg : in Nav_Trans.T) is
   begin
      -- Push the argument onto the test history for looking at later:
      Self.Navigation_Translation_History.Push (Arg);
   end Navigation_Translation;
