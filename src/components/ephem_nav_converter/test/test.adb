--------------------------------------------------------------------------------
-- Ephem_Nav_Converter Tests
--------------------------------------------------------------------------------

with AUnit.Reporter.Text;
with AUnit.Run;
with Ephem_Nav_Converter_Tests.Implementation.Suite;
...
procedure Test is
   ...
   procedure Runner is new AUnit.Run.Test_Runner (Ephem_Nav_Converter_Tests.Implementation.Suite.Get);
