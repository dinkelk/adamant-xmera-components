--------------------------------------------------------------------------------
-- Ephem_Nav_Converter Component Implementation Spec
--------------------------------------------------------------------------------

-- Includes:
with Tick;
with Ephem_Nav_Converter_Algorithm_C; use Ephem_Nav_Converter_Algorithm_C;

-- Ephemeris to navigation converter algorithm converts ephemeris messages to
-- navigation translation messages.
package Component.Ephem_Nav_Converter.Implementation is

   -- The component class instance record:
   type Instance is new Ephem_Nav_Converter.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Ephem_Nav_Converter.Base_Instance with record
      Alg : Ephem_Nav_Converter_Algorithm_Access := null;
   end record;
