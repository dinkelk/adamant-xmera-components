...
package body Component.Inertial_Filter.Implementation.Tester is
   ...
   -----------------------------------------------
   -- Description:
   --    Events for the Inertial Filter component.
   ...
   -----------------------------------------------
   -- Description:
   --    Packets for the Inertial Filter component.
   ...
   overriding procedure Filter_Diagnostics (Self : in out Instance; Arg : in Inertial_Filter_Output.T) is
   begin
      -- Push the argument onto the test history for looking at later:
