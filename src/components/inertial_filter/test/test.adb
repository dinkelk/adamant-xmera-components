--------------------------------------------------------------------------------
-- Inertial_Filter Tests
--------------------------------------------------------------------------------

with AUnit.Reporter.Text;
with AUnit.Run;
with Inertial_Filter_Tests.Implementation.Suite;
...
procedure Test is
   ...
   procedure Runner is new AUnit.Run.Test_Runner (Inertial_Filter_Tests.Implementation.Suite.Get);
