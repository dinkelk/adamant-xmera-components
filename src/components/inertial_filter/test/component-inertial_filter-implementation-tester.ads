...
-- commanded period. Wraps the InertialFilterAlgorithm C++ algorithm via its C
-- shim.
package Component.Inertial_Filter.Implementation.Tester is
   ...
   package Filter_Diagnostics_History_Package is new Printable_History (Inertial_Filter_Output.T, Inertial_Filter_Output.Representation.Image);
   ...
   overriding procedure Filter_Diagnostics (Self : in out Instance; Arg : in Inertial_Filter_Output.T);
