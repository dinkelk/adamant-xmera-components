--------------------------------------------------------------------------------
-- Rate_Control Component Implementation Spec
--------------------------------------------------------------------------------

-- Includes:
with Tick;
with Rate_Control_Algorithm_C; use Rate_Control_Algorithm_C;

-- Rate control algorithm computes the required control torque based on attitude
-- guidance.
package Component.Rate_Control.Implementation is

   -- The component class instance record:
   type Instance is new Rate_Control.Base_Instance with private;
...
private
   ...
   -- The component class instance record:
   type Instance is new Rate_Control.Base_Instance with record
      Alg : Rate_Control_Algorithm_Access := null;
   end record;
