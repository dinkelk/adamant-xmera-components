--------------------------------------------------------------------------------
-- Mimu_Majority_Vote Tests
--------------------------------------------------------------------------------

with AUnit.Reporter.Text;
with AUnit.Run;
with Mimu_Majority_Vote_Tests.Implementation.Suite;
...
procedure Test is
   ...
   procedure Runner is new AUnit.Run.Test_Runner (Mimu_Majority_Vote_Tests.Implementation.Suite.Get);
