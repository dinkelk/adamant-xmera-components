--------------------------------------------------------------------------------
-- Sun_Search Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Sun_Search_Reciprocal;
...
-- slew maneuvers.
package Component.Sun_Search.Implementation.Tester is

   use Component.Sun_Search_Reciprocal;
   ...
   type Instance is new Component.Sun_Search_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Sun_Search.Implementation.Instance;
      -- Connector histories:
   ...
   -----------------------------------------------
   -- Description:
   --    Data products for the Sun Search component.
   -- Attitude guidance output containing reference angular velocity, body error
   -- rates, and reference acceleration.
...
end Component.Sun_Search.Implementation.Tester;
