--------------------------------------------------------------------------------
-- Average_Mimu_Data Tests
--------------------------------------------------------------------------------

with AUnit.Reporter.Text;
with AUnit.Run;
with Average_Mimu_Data_Tests.Implementation.Suite;
...
procedure Test is
   ...
   procedure Runner is new AUnit.Run.Test_Runner (Average_Mimu_Data_Tests.Implementation.Suite.Get);
